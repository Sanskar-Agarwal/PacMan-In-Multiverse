...
public class PacActor extends Actor implements GGKeyRepeatListener {
    private static final int FURIOUS_TIME = 3;
    private static final int FROZEN_TIME = 3;
    ...
    private Location closestPillLocation() {
        ...
        for (Location location: itemHandler.getPillAndItemLocations()) {
    ...
    private void eatPill(Location location) {
        ...
        if (c.equals(Color.white)) {
            ...
            if (game.getIsMultiverse()) {
                game.getMonsterHandler().furiousMode(FURIOUS_TIME);
            }
            ...
            game.getMonsterHandler().freezeMonsters(FROZEN_TIME);
        }
